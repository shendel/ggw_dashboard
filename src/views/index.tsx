        ...
        <div className="max-w-7xl mx-auto space-y-8">
            ...
            <header className="flex justify-between items-start mb-8">
                ...
                <div className="text-right text-sm text-slate-500 mono">
                    <div className="flex items-center gap-2 justify-end mb-1">
                        ...
                        Last Updated: 11:48:19
                    </div>
                    <div>Block: #18,245,992</div>
                </div>
            </header>
            ...
            <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div className="gradient-border rounded-xl p-5 card-hover bg-slate-900/50 backdrop-blur">
                        <div className="flex justify-between items-start mb-3">
                            <span className="text-xs font-medium text-slate-400 uppercase tracking-wider">Active Players</span>
                        ...
                        <div className="text-3xl font-bold text-white mb-1">129</div>
                    ...
                    <div className="gradient-border rounded-xl p-5 card-hover bg-slate-900/50 backdrop-blur">
                        ...
                        <div className="text-3xl font-bold text-white mb-1">848,061 <span className="text-lg text-slate-400 font-normal">GGC</span></div>
                        <div className="text-xs text-slate-500">≈ $101,767.32</div>
                    </div>
            ...
            <section>
                <div className="flex items-center gap-3 mb-6">
                    <div className="w-1 h-6 bg-purple-500 rounded-full"></div>
                    <h2 className="text-xl font-semibold text-white uppercase tracking-wide">Tokenomics & Pools</h2>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
                    ...
                    <div className="gradient-border rounded-xl p-6 card-hover bg-gradient-to-br from-blue-900/20 to-slate-900/50">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                <div className="text-sm font-medium text-slate-300">Game Treasury (Bank)</div>
                                <div className="text-3xl font-bold text-white">850,000 <span className="text-lg text-slate-400 font-normal">GGC</span></div>
                            </div>
                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-slate-900/30 border border-slate-800 rounded-xl p-4 flex justify-between items-center">
                        <span className="text-slate-400">GGC Token Price</span>
                        <span className="text-xl font-bold text-white mono">$0.12 <span className="text-sm text-slate-500">USD</span></span>
                    </div>
                    <div className="bg-slate-900/30 border border-slate-800 rounded-xl p-4 flex justify-between items-center">
                        <span className="text-slate-400">Circulating Supply</span>
                        <span className="text-xl font-bold text-white mono">10,000,000 <span className="text-sm text-slate-500">GGC</span></span>
                    </div>
                </div>
            </section>
